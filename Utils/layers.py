...
L1_LONG = [
    ...
    ['FUNCTION_UNDO','FUNCTION_CUT','FUNCTION_COPY','FUNCTION_PASTE',
     'SPECIAL_GRAVE','QUOTE','MINUS','EQUAL','LEFT_BRACKET','RIGHT_BRACKET'],
...
L3_SHORT = [
    ...
    ['F11','F12','','','','MEDIA_PREV_TRACK','MEDIA_PLAY','MEDIA_MUTE','MEDIA_NEXT_TRACK',''],
    ['','','','','','BRIGHTNESS_UP','MEDIA_VOLUME_DOWN','MEDIA_VOLUME_UP','BRIGHTNESS_DOWN',''],
    ['ESC','SPACE','LAYER_UP','','','LAYER_DOWN','ENTER','BACKSPACE','','']
]
...
# --------------------------------------------------
# Layer 05, Navigation layer
# --------------------------------------------------

L5_SHORT = [
    ['SPECIAL_TEST','','PAGE_UP','','','SHORTCUT_SWITCH_WINDOW_TO_LEFT','SHORTCUT_SWITCH_WINDOW_TO_DOWN','SHORTCUT_SWITCH_WINDOW_TO_UP','SHORTCUT_SWITCH_WINDOW_TO_RIGHT',''],
    ['','HOME','PAGE_DOWN','END','','LEFT','DOWN','UP','RIGHT',''],
    ['','FUNCTION_CLOSE','CAPSLOCK','','','','FUNCTION_ZOOM_OUT','FUNCTION_ZOOM_IN','',''],
    ['ESC','SPACE','LAYER_UP','','','LAYER_DOWN','ENTER','BACKSPACE','','']
]

L5_LONG = [
    ['','','','','','','','','',''],
    ['ONE_HANDED_LEFT_GUI','ONE_HANDED_LEFT_ALT','ONE_HANDED_LEFT_CTRL','ONE_HANDED_LEFT_SHIFT','TAB','TAB',
     'ONE_HANDED_RIGHT_SHIFT','ONE_HANDED_RIGHT_CTRL','ONE_HANDED_RIGHT_ALT','ONE_HANDED_RIGHT_GUI'],
